...
require("../konek/crud.php");
    ...
    if ($cek == 0) {
		$simpan = mysqli_query($koneksi,"INSERT INTO keranjang(idsiswa,idproduk,jumlah,harga) VALUES('$ids','$idp','$jumlah','$harga')");
	...
	$simpan = mysqli_query($koneksi,"UPDATE keranjang SET jumlah='$total' WHERE idsiswa='$ids' AND idproduk='$idp'");
