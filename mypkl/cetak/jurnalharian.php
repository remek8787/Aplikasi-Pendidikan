				...
				?>
					<div class="row">
                          <div class="col-md-8">
                                <div class="card">
									...
									<h5 class="card-title">CETAK JURNAL HARIAN</h5>
										</div>
                                    <div class="card-body">
                                         ...
                                         <th>WAKTU</th>									  
                                          ...
                                          <tbody>
                                            ...
                                            <tr style="vertical-align:middle;">
											 ...
											 <td>
											<a href="cetak/cetakjurnalharian.php?ids=<?= $siswa['id_siswa'] ?>&b=<?= $b ?>&d=<?= $d ?>" target="_blank"  class="btn btn-sm btn-primary"><i class="material-icons">print</i></a>
					...
					<script type="text/javascript">
                                $('#pilih').click(function() {
                                    ...
                                    var b = $('#bulan').val(); 
									var d = $('#dudi').val(); 
                                    location.replace("?pg=<?= enkripsi('jurnalharian') ?>&k=" + k + "&b=" + b + "&d=" + d);
                                }); 
                            </script>
