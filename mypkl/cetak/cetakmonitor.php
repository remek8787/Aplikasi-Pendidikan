				...
				<?php if ($ac == '') : ?>
					<div class="row">
                          <div class="col-md-8">
                                <div class="card">
									...
									<h5 class="card-title">CETAK MONITORING DAN EVALUASI <?= $kelas ?></h5>
										</div>
                                    <div class="card-body">
                                         ...
                                         <th>NAMA SISWA</th>								  
                                          ...
                                          <tbody>
                                            ...
                                            <tr style="vertical-align:middle;">
                                             ...
                                             <td><?= $siswa['jk'] ?></td>
											 <td>
											<a href="cetak/cetak4.php?&ids=<?= $siswa['id_siswa'] ?>&d=<?= $d ?>" target="_blank" class='btn btn-sm btn-success'><i class="material-icons">print</i></a>
											 </td>
					...
					<script type="text/javascript">
                                $('#pilih').click(function() {
									...
									var d = $('#dudi').val(); 
                                    location.replace("?pg=<?= enkripsi('cetakmonitor') ?>&k=" + k + "&d=" + d);
                                }); 
                            </script>
