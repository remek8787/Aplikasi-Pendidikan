					...
					$id = $_GET['id'];
					$pkl = fetch($koneksi,'pkl_kegiatan',['id'=>$id]);
					...
					<div class="row">
                          <div class="col-md-8">
                                <div class="card">
									...
									<br>
									<p>Kegiatan : <?= $pkl['kegiatan'] ?></p>
									</div>
									<div class="col-md-6">
									<img src="../images/fotopkl/<?= $pkl['foto'] ?>" style="width:100%;height:auto">
										 </div>
										 </div>
										</div>
									</div>
					       ...
					       <div class="col-md-4">                   
                                <div class="card">
									...
									<option value="<?= $siswa['kelas'] ?>"><?= $siswa['kelas'] ?></option>
									  ...
									  <label class="bold">CATATAN DARI PEMBIMBING</label>
									 <div class="input-group mb-1">
