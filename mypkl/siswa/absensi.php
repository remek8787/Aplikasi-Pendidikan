					...
					<div class="row">
                          <div class="col-md-8">
                                <div class="card">
									...
									<h5 class="card-title">PRESENSI HARI INI <?= $tanggal ?></h5>
										</div>
                                    <div class="card-body">
                                        ...
                                        <thead>
                                         ...
                                         <th>WAKTU</th>									  
                                          ...
                                          <tbody>
											<?php
											$no=0;
											$query = mysqli_query($koneksi, "SELECT * FROM pkl_kegiatan WHERE kelas='$kelas' and tanggal='$tanggal'");
                                            ...
                                            <tr style="vertical-align:middle;">
                                             ...
                                             <td><?= $data['kelas'] ?></td>
											 <td>
											 <a href="lokasi.php?&lat=<?= $data['lat'] ?>&lon=<?= $data['lon'] ?>" target="_blank" class="btn btn-sm btn-primary"><i class="material-icons">visibility</i></a>
											 </td>
