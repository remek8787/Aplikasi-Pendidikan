     ...
     <tr>
	  <td width='650px'>
	   ...
	   <p style="text-align:justify; text-indent:0.5in;">Bersamaan surat ini kami sampaikan bahwa ananda <b><?= $siswa['nama'] ?></b> sudah melakukan dan mengulangi pelanggaran aturan sekolah <?= $setting['sekolah'] ?>, yakni tidak mengikuti aturan tata tertib yang berlaku diantaranya:</p>
		 ...
		 <?php
		 $no=0;
          $query = mysqli_query($koneksi, "select * from bk_siswa WHERE nis='$siswa[nis]' AND sts='SP2'");                          
		...
		<br>
		 ...
		 Kami memberikan kesempatan pada <b><?= $siswa['nama'] ?></b> untuk tidak mengulangi hal tersebut lagi sejak surat ini diterbitkan. Apabila terbukti melanggar aturan tersebut kembali maka teguran, akan kami lanjutkan dengan SP 3.
		 </p>
		 <p style="text-align:justify; text-indent:0.5in;">
...
$dompdf->render();
$dompdf->stream("SP2 $siswa[nama].pdf", array("Attachment" => false));
