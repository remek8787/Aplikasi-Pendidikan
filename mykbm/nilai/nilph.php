                          ...
                          <div class="col-md-8">
								...
								<form id="formnilai">
                                        ...
                                        <table  style="width:100%;font-size:12px">
											...
											<?php
											$no = 0;
											$query = mysqli_query($koneksi,"SELECT id_siswa,nis,kelas,nama FROM siswa WHERE kelas='$kelasmu'");
											   ...
											   <tr style="vertical-align:middle;">
                                                 <td><?= $no; ?></td>
                                                  <td><?= $data['nis'] ?></td>
													<td><?= $data['nama'] ?></td>
													<td>
													<input type="number" name="nilai[]<?php echo $no; ?>" class="form-control" value="0" required="true" style="width:100px;"> 
                                ...
                                <div class="card-body">
									...
									<div class="col-md-12 mb-1">
									   <label class="bold">Guru</label>
										...
										location.replace("?pg=<?= enkripsi('nilai') ?>&k=" + k + "&g=" + g + "&m=" + m + "&t=" + tgl);
										}); 
									</script>
									 </div>
					            </div>
