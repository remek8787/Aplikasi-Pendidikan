                   ...
                   <div class="row">
                      <div class="col-md-8">
                        <div class="card">
							...
							<h5 class="card-title">DIFFRENSIASI</h5>
							</div>
                            <div class="card-body">
								<div class="row">
								<?php
								...
								<div class="d-flex align-items-center flex-column mb-4">
									...
									<div class="text-muted">MODUL AJAR DIFFR</div>
                          ...
                          <div class="col-md-4">
                                ...
                                <div class="card-body">
									...
									<div class="h5 mb-0"><?= $setting['sekolah'] ?></div>
									 ...
									 <form method="GET" action="adm/modulajar3.php" target="_blank"  enctype="multipart/form-data">
