                   ...
                   <div class="row">
                      <div class="col-md-8">
                        <div class="card">
							...
							<h5 class="card-title">DISCOVERY LEARNING</h5>
							</div>
                            <div class="card-body">
								<div class="row">
								<?php
								if($user['level']=='admin'):
								$query = mysqli_query($koneksi, "SELECT * FROM cp WHERE smt='$semester' ORDER BY rand() LIMIT 3"); 
								elseif($user['level']=='guru'):
								$query = mysqli_query($koneksi, "SELECT * FROM cp WHERE guru='$id_user' and smt='$semester'"); 
								endif;
								...
								<div class="d-flex align-items-center flex-column mb-4">
									...
									<div class="text-muted">MODUL AJAR DL</div>
									<div class="h5 mb-0"><?= $mpl['kode'] ?> <?= $data['tingkat'] ?></div>
										  <span><?= $peg['nama'] ?></span>
										</div>
									  </div>
									</div>
                          ...
                          <div class="col-md-4">
                                ...
                                <div class="card-body">
									...
									<div class="h5 mb-0"><?= $setting['sekolah'] ?></div>
									 ...
									 <form method="GET" action="adm/modulajar2.php" target="_blank"  enctype="multipart/form-data">
									...
									<div class="col-md-12 mb-1">
									   <label class="bold">Guru</label>
										...
										<div class="col-md-12 mb-1">
									   <label class="bold">Pertemuan ke</label>
											<select name="elemen" id="elemen" class='form-select' style='width:100%' required="true" >                                         
