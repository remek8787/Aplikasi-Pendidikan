...
<br>   
 <b>3. KEGIATAN PEMBELAJARAN</b>											
	...
	<table width="100%" border="1" style="margin-left:33px">
	<tr style="vertical-align:middle">
    <td width='20%'>Kegiatan Literasi</td>
	<td>Peserta didik diberi motivasi dan panduan untuk melihat, mengamati, membaca dan menuliskannya kembali. Mereka diberi tayangan dan bahan bacaan terkait materi <i><?= $dt['sisipan'] ?></i></td>
	</tr>
	<tr style="vertical-align:middle">
    <td width='20%'>Critical Thinking</td>
	<td>Guru memberikan kesempatan untuk mengidentifikasi sebanyak mungkin hal yang belum dipahami, dimulai dari pertanyaan faktual sampai ke pertanyaan yang bersifat hipotetik. Pertanyaan ini harus tetap berkaitan dengan materi <i><?= $dt['sisipan'] ?></i></td>
	</tr>
	<tr style="vertical-align:middle">
    <td width='20%'>Collaboration</td>
	<td>Peserta didik dibentuk dalam beberapa kelompok untuk mendiskusikan, mengumpulkan informasi, mempresentasikan ulang, dan saling bertukar informasi mengenai <i><?= $dt['sisipan'] ?></i></td>
	</tr>
	<tr style="vertical-align:middle">
    <td width='20%'>Communication</td>
	<td>Peserta didik mempresentasikan hasil kerja kelompok atau individu secara klasikal, mengemukakan pendapat atas presentasi yang dilakukan kemudian ditanggapi kembali oleh kelompok atau individu yang mempresentasikan</td>
	</tr>
	<tr style="vertical-align:middle">
    <td width='20%'>Creativity</td>
	<td>Guru dan peserta didik membuat kesimpulan tentang hal-hal yang telah dipelajari terkait <i><?= $dt['sisipan'] ?></i>. Peserta didik kemudian diberi kesempatan untuk menanyakan kembali hal-hal yang belum dipahami</td>
	</tr>
	</table>
    ...
    <td width='2%'></td>
	<td width='1%'>*</td>
    <td>Guru bersama peserta didik membuat rangkuman/simpulan pelajaran tentang point-point penting yang muncul dalam kegiatan pembelajaran yang baru dilakukan</td>	
	</td>	
	</tr>
	<tr style="vertical-align:top">
    <td width='2%'></td>
...
<b>4. PENILAIAN (ASSESMENT)</b>											
	...
	<td>Penilaian Keterampilan : berupa penilaian unjuk kerja, penilaian proyek, penilaian produk dan penilaian portofolio</td>	
	</tr>
 </table>
  <br>
...
$dompdf->render();
$dompdf->stream("RPP MODEL 2 SMT-".$dt['smt']." ". $kelas ." - ".$map['kode'].".pdf", array("Attachment" => false));
exit(0);
?>