                   ...
                   <div class="row">
                      <div class="col-md-8">
                        <div class="card">
							...
							<h5 class="card-title">CETAK RPP MODEL 2</h5>
							</div>
                            <div class="card-body">
								<div class="card-box table-responsive">
                                    <table id="datatable1" class="table table-bordered table-hover" style="width:100%;font-size:12px">
                                       ...
                                       <tr>
										...
										<td>										
										<a href="?pg=<?= enkripsi('crpp2') ?>&id=<?= $data['id'] ?>" class="btn btn-sm btn-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="Cetak"><i class="material-icons">print</i> </a>
										</td>
                                       </tr>
										<?php endwhile; ?>
                                       </tbody>
			            ...
			            <div class="col-md-4">
                                ...
                                <div class="card-body">
									...
									<form id='formcp'  method="GET" target="_blank" action="kurtilas/rpp2.php"  enctype="multipart/form-data">
