...
?>           
                          ...
                          <div class="col-md-8">
                                <div class="card">
                                    <div class="card card-header">
                                        <h5 class="card-title">REGISTRASI KARTU SISWA</h5>										
                                    </div>
                                    <div class="card-body">									
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= $data['nis'] ?></td>
                                                     <td><?= $data['nama'] ?></td>
													  <td><?= $data['kelas'] ?></td>
													  <td>
											          <a href="?pg=<?= enkripsi('register') ?>&ids=<?= $data['id_siswa'] ?>"> <button class='btn btn-sm btn-success' data-bs-toggle="tooltip" data-bs-placement="top" title="Registrasi RFID"><i class="material-icons">edit</i></button></a>
											          </td>
                                                </tr>
												<?php endwhile; ?>
                                                </table>
    ...
    $('#formkartu').submit(function(e){
		...
		$.ajax(
		{
			...
			setTimeout(function()
				{
				window.location.replace('?pg=<?= enkripsi("register") ?>');
						}, 1000);
