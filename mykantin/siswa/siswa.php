									...
									<div class="card-box table-responsive">
                                         <table id="datatable1" class="table table-bordered table-hover edis2" style="width:100%;font-size:12px">
                                            ...
                                            <tbody>
                                               <?php
											$no=0;
											$query = mysqli_query($koneksi, "SELECT * FROM siswa where nokartu<>''"); 
											...
											$no++;
											   ?>
												...
												<td>
												<a href="?pg=<?= enkripsi('pelanggan') ?>&ac=<?= enkripsi('lihat') ?>&ids=<?= $data['id_siswa'] ?>"> <button class='btn btn-sm btn-success' data-bs-toggle="tooltip" data-bs-placement="top" title="Lihat Detail"><i class="material-icons">visibility</i></button></a>
												</td>
                                                </tr>
												<?php endwhile; ?>
												</tbody>
