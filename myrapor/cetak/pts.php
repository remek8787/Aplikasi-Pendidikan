                          ...
                          <div class="col-md-8">
                                <div class="card">
                                    <div class="card card-header">
										...
										CETAK RAPOR PTS <span class="badge badge-success"><?= $semester ?></span>
											   ...
											   <tr style="vertical-align:middle;">
                                                 <td><?= $no; ?></td>
                                                  <td><?= $data['nis'] ?></td>
													...
													<td>
													<?php if($data['t_lahir']<>''): ?>
													<a href="cetak/rapor_pts.php?ids=<?= $data['id_siswa'] ?>" target="_blank" class="btn btn-sm btn-warning"><i class="material-icons">print</i></a>					
													<?php else: ?>
                                ...
                                <div class="card-body">
									...
									<div class="col-md-12 mb-1">
									   <label class="bold">Kelas</label>
										...
										var k = $('.kelas').val();
										location.replace("?pg=<?= enkripsi('rappts') ?>&k=" + k);
										}); 
									</script>
									 </div>
					            </div>
