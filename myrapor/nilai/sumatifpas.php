                          ...
                          <div class="col-md-8">
								...
								<form id="formnilai">
                                        ...
                                        <table  style="width:100%;font-size:12px">
											...
											$nil = mysqli_fetch_array(mysqli_query($koneksi, "SELECT * FROM nilai_sumatif  WHERE ket='PAS' and idsiswa='$data[id_siswa]' and mapel='$mapelmu' and smt='$semester' and tp='$tapel'"));
                                ...
                                <div class="card-body">
									...
									<div class="col-md-12 mb-1">
									   <label class="bold">Guru</label>
										...
										location.replace("?pg=<?= enkripsi('sumatifpas') ?>&k=" + k + "&g=" + g + "&m=" + m + "&kt=" + kt);
										}); 
									</script>
									 </div>
					            </div>
