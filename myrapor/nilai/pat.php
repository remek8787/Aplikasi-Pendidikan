                          ...
                          <div class="col-md-8">
                                <div class="card">
                                    <div class="card card-header">
                                        <h5 class="bold">
										<?php if($_GET['kt']==''): ?>
										PENGOLAHAN NILAI PAS <span class="badge badge-success"><?= $semester ?></span>
										<?php else: ?>
										INPUT NILAI <?= $_GET['kt'] ?> 
								...
								<form id="formnilai">
									...
									<input type="hidden" name="kelasmu" value="<?= $kelasmu ?>">
                                        ...
                                        <table  style="width:100%;font-size:12px">
											...
											$nilki3 = mysqli_fetch_array(mysqli_query($koneksi, "SELECT * FROM nilai_rapor  WHERE ki='KI-3' and ket='PAS' and idsiswa='$data[id_siswa]' and mapel='$mapelmu' and smt='$semester' and tp='$tapel'"));
											   ...
											   <tr style="vertical-align:middle;">
                                                 <td><?= $no; ?></td>
                                                  <td><?= $data['nis'] ?></td>
													<td><?= $data['nama'] ?></td>
													<td>
													<input type="number" name="nilai[]<?php echo $no; ?>" class="form-control" 
													<?php if($ki=='KI-3'): ?> value="<?= $nilki3['nilai'] ?>"  
													<?php else: ?> value="<?= $nilki4['nilai'] ?>"  <?php endif; ?> required="true" style="width:100px;"> 
                                ...
                                <div class="card-body">
									...
									<div class="col-md-12 mb-1">
									  <label class="bold">Semester</label>
                                       ...
                                       <input type="hidden" name="ket"  id="ket" class='form-control ket' value="PAT" > 
                                       <input type="hidden" name="ki"  id="ki" class='form-control ki' value="KI-3" > 
									...
									<div class="col-md-12 mb-1">
									   <label class="bold">Guru</label>
										...
										var m = $('.mapel').val();
										var ki = $('.ki').val();
										location.replace("?pg=<?= enkripsi('pas') ?>&k=" + k + "&g=" + g + "&m=" + m + "&kt=" + kt + "&ki=" + ki);
										}); 
									</script>
									 </div>
					            </div>
