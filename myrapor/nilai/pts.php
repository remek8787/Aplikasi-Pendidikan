								...
								<form id="formnilai">
									...
									<input type="hidden" name="kelasmu" value="<?= $kelasmu ?>">
                                        ...
                                        <table  style="width:100%;font-size:12px">
											...
											$nilki3 = mysqli_fetch_array(mysqli_query($koneksi, "SELECT * FROM nilai_rapor  WHERE ki='KI-3' and ket='PTS' and idsiswa='$data[id_siswa]' and mapel='$mapelmu' and smt='$semester' and tp='$tapel'"));
                                ...
                                <div class="card-body">
									...
									<div class="col-md-12 mb-1">
									   <label class="bold">Guru</label>
										...
										var m = $('.mapel').val();
										var ki = $('.ki').val();
										location.replace("?pg=<?= enkripsi('pts') ?>&k=" + k + "&g=" + g + "&m=" + m + "&kt=" + kt + "&ki=" + ki);
										}); 
									</script>
									 </div>
					            </div>
