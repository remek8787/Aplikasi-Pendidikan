                          ...
                          <div class="col-md-8">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="bold">INPUT PRESTASI <span class="badge badge-primary"><?= strtoupper($kelas) ?></span></h5>
											   ...
											   ?>
                                                <tr>
                                                    <td><?= $no; ?></td>                           
                                                     ...
                                                     <td><?= $data['tingkat'] ?></td>													 
													 <td>
													<a href="?pg=<?= enkripsi('prestasi') ?>&ac=<?= enkripsi('input') ?>&ids=<?= $data['id_siswa'] ?>" class="btn btn-sm btn-primary"><i class="material-icons">add</i></a>												
													 </td>
					       ...
					       <div class="col-md-4">
                                ...
                                <div class="card widget widget-payment-request">
                                    <div class="card-header">                                    
										<h5 class="card-title">INPUT PRESTASI</h5>									
									</div>
                                    <div class="card-body">
                                        ...
                                        <div class="widget-payment-request-container">
                                            <div class="widget-payment-request-author">
                                                ...
                                                <div class="widget-payment-request-author-info">
                                                    <span class="widget-payment-request-author-name">INPUT PRESTASI</span>
                                ...
                                $('#simpan').click(function() {
                                    ...
                                    location.replace("?pg=<?= enkripsi('prestasi') ?>&kelas=" + kelas );
                                }); 
                            </script>                                             
                                                </div>                                               
                                            </div>
					       ...
					       <div class="col-md-4">
								...
								<select name='ids' class='form-select' required='true' style="width: 100%">
									...
									<option value="<?= $kelas ?>"><?= $kelas ?></option>						
									   ...
									   <label class="bold">Jenis Prestasi</label>
								<div class="input-group mb-2">
								<textarea class="form-control" name="prestasi" rows="5"></textarea>
							     </div>		
										 <label class="bold">Tingkat</label>
								<div class="input-group mb-2">
								<input type="text" name="tingkat" class="form-control" >
							     </div>			
                               <label class="bold">Juara ke</label>
								<div class="input-group mb-2">
					 ...
					 <?php endif ?> 
						 ...
						 <script>
												$('#formpeskul').submit(function(e){
													...
													{
														type: 'POST',
														 url: 'walas/tsiswa.php?pg=prestasi',
														data: data,
														cache: false,
														contentType: false,
														processData: false,
														...
														success: function(data){
														 ...
														 setTimeout(function() {
                                                        window.location.replace('?pg=<?= enkripsi(prestasi) ?>&kelas=<?= $kelas ?>');
                                                          }, 2000);
