                          ...
                          <div class="col-md-8">
                                                ...
                                                <tr>
                                                    <td><?= $no; ?></td>                           
													 ...
													 <td><?= ucwords(strtolower($data['nama'])); ?></td>							
													  <td><h5><span class="badge badge-primary"><?= $data['sakit'] ?></span></h5></td>
													   <td><h5><span class="badge badge-warning"><?= $data['izin'] ?></span></h5></td>
													    <td><h5><span class="badge badge-danger"><?= $data['alpha'] ?></span></h5></td>
													 <td>
													<a href="?pg=<?= enkripsi('absensi') ?>&ac=<?= enkripsi('input') ?>&ids=<?= $data['id_siswa'] ?>" class="btn btn-sm btn-primary"><i class="material-icons">add</i></a>
					       ...
					       <div class="col-md-4">
                                ...
                                $('#simpan').click(function() {
                                    ...
                                    location.replace("?pg=<?= enkripsi('absensi') ?>&kelas=" + kelas );
                                }); 
                            </script>                                             
                                                </div>                                               
                                            </div>
												...
												$('#formpeskul').submit(function(e){
													...
													$.ajax(
													{
														...
														success: function(data){
														 ...
														 setTimeout(function() {
                                                        window.location.replace('?pg=<?= enkripsi(absensi) ?>&kelas=<?= $kelas ?>');
                                                          }, 2000);
