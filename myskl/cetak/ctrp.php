...
<?php
    ...
    ?>
			<div class="row">
			 ...
			 <h5 class="bold">CETAK TRANSKIP NILAI</h5>
                                                ...
                                                <tr>
												 ...
												 <a href="#"><img src="<?= $baseurl ?>/images/siswa.png" style="max-width:30px" alt=""></a>
												  ...
												  <?php endif; ?>
													...
													<?php if($data['ket']<>''): ?>
													<a href="skl/transkipnilai.php?ids=<?= $data['id_siswa'] ?>" target="_blank"> <button class="btn btn-sm  btn-primary mb-1" type="button"> <i class="material-icons">print</i></button></a>				
					...
					<div class="col-md-12">
						...
						<script type="text/javascript">
                                $('#cari').click(function() {
                                    ...
                                    location.replace("?pg=<?= enkripsi('ctrp') ?>&kelas=" + kelas);
                                }); 
                            </script>
		<script>
