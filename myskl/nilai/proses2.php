...
$sheet->setCellValue('A1', "UPLOAD DATA NILAI UJIAN SEKOLAH "); 
...
$sheet->setCellValue('I4', "PRAKTEK"); 
$sheet->setCellValue('J4', "TEORI"); 
...
while($data = mysqli_fetch_array($sql)){ 
    ...
    $sheet->setCellValue('C' . $i, $jurusan);
    $sheet->setCellValue('D' . $i, $data['id_siswa']);
    $sheet->setCellValue('E' . $i, $data['id_siswa']);
...
header("Content-Disposition: attachment; filename=NILAI US ".$mpl."-".$kelas.".xlsx");
