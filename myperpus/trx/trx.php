                            ...
                            <div class="col-xl-2">
                                    ...
                                    <div class="card-body">
												...
												<?php if($barkode['kode']<>''): ?>
												<center><img src="../qrkode/<?= $barkode['kode']; ?>.png" class="responsive" style="margin-top:-10px;"></center>
												<?php endif; ?>
                       ...
                       <div class="row">
                          <div class="col-md-12">
                                <div class="card">
                                  ...
                                  <h5><span class="badge badge-primary kanan">MODE MESIN <?= $sts; ?></span></h5>
										</div>
                                    </div>
                                    <div class="card-body">
									<div class="card-box table-responsive">
                                        <table id="datatable1" class="table table-bordered table-hover edis2" style="width:100%;font-size:12px">
											...
											<?php
											$no=0;
											$query = mysqli_query($koneksi, "SELECT * FROM transaksi where ket='Pinjam' and tanggal='$tanggal'  ORDER BY id DESC LIMIT 5"); 
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= $siswa['nama'] ?></td>
                                                     ...
                                                     <td><?= $buku['judul'] ?></td>
													  ...
													  <td><h5><span class="badge badge-danger"><?= $data['ket'] ?></span></h5></td>
                                                </tr>
												<?php endwhile; ?>
												</tbody>
                                                </table>
